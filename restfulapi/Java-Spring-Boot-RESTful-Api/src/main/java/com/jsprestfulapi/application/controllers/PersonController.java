...
import com.jsprestfulapi.application.services.LoggerService;
import com.jsprestfulapi.application.services.PersonServices;
...
public class PersonController {
	...
	public ResponseEntity<PagedModel<EntityModel<PersonVO>>> findAll(
		...
		_logger.addLogMessage("Buscando todos os dados pessoais."); 
		return ResponseEntity.ok(_personService.findAll(pageable));
	}
	...
	public PersonVO findById(@PathVariable(value = "id") Long id){
		_logger.addLogMessage("Buscando usuario com id = " + id + ".");
	...
	public PersonVO create(@RequestBody PersonVO person){
		_logger.addLogMessage("Criando usuario " + person.getNome() + ".");
		return _personService.create(person);
	}
	
	@PatchMapping(value = "/{id}", consumes = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML}, 
				produces = {MediaType.APPLICATION_JSON, MediaType.APPLICATION_XML, MediaType.APPLICATION_YML})
	@Operation(summary = "Updates a Person Age", description = "Updated", tags = {"People"},
	responses = {
		@ApiResponse(description = "Success", responseCode = "200", 
			content = @Content(schema = @Schema(implementation = PersonVO.class))
		),
	...
	@Operation(summary = "Deletes a Person", description = "Deleted", tags = {"People"},
	responses = {
		@ApiResponse(description = "No Content", responseCode = "204", content = @Content),
		@ApiResponse(description = "Bad Request", responseCode = "400", content = @Content),
		@ApiResponse(description = "Unauthorized", responseCode = "401", content = @Content),
	...
	public ResponseEntity<?> delete(@PathVariable(value = "id") Long id){
		_logger.addLogMessage("Deletando usuario de id = " + id + ".");
